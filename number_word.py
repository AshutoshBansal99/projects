...
title = Label(root, text="Number to Words converter",
              fg="Red", font=("Arial", 20, 'bold')).place(x=220, y=10)
...
btn = Button(master=root, text="calculate", fg="green", font=(
    "Arial", 10, 'bold'), command=num_to_words).place(x=280, y=230)


display = Label(root, text="", fg="green", font=(
    "Arial", 24, 'italic', 'underline'))
display.place(x=25, y=300)


photo = PhotoImage(
    file="D:/vscode files/python/python project/Num2Words/number.png")
root.iconphoto(True, photo)

root.mainloop()
# Num2Words/number.png
